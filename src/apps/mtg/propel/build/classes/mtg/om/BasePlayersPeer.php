...
abstract class BasePlayersPeer {
	...
	const CLASS_DEFAULT = 'mtg.Players';
	...
	const PASSWORD = 'players.PASSWORD';

	/** the column name for the EMAIL field */
	const EMAIL = 'players.EMAIL';

	/** the column name for the EXP field */
	const EXP = 'players.EXP';

	/**
	 * An identiy map to hold any loaded instances of Players objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Password', 'Email', 'Exp', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'password', 'email', 'exp', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::PASSWORD, self::EMAIL, self::EXP, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'PASSWORD', 'EMAIL', 'EXP', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'password', 'email', 'exp', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Password' => 2, 'Email' => 3, 'Exp' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'email' => 3, 'exp' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::PASSWORD => 2, self::EMAIL => 3, self::EXP => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'EMAIL' => 3, 'EXP' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'email' => 3, 'exp' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(PlayersPeer::USERNAME);
			$criteria->addSelectColumn(PlayersPeer::PASSWORD);
			$criteria->addSelectColumn(PlayersPeer::EMAIL);
			$criteria->addSelectColumn(PlayersPeer::EXP);
		} else {
	 ...
	 *
	 * @param      Players $value A Players object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Players $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = PlayersPeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = PlayersPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + PlayersPeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? PlayersPeer::CLASS_DEFAULT : PlayersPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Players or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Players or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the players table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Players or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(Players $obj, $cols = null)
	{
		$columns = array();
